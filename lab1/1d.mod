...
subject to Time {i in ADVER}:
   min_time[i] <= bought[i] <= max_time[i];
...
param: 
    ADVER: cost    reach   min_time max_time  craft_time :=
    TV      20000   1.8     10       Infinity   1
    MAG     10000   1.0     2        Infinity   3
    RADIO   2000    0.25    0        120        1
    ;
